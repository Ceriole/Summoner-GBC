/*
  DO NOT INCLUDE THIS FILE IN ANY SOURCE FILES!!!
  Include this file in your editor by setting it as an include for your processor.
  This will fix any intellisense/syntax checking errors
*/
